...
ASM_SFILES := ./assembler/main_assembler.c ./assembler/print_errors_usage.c ./assembler/encoding_funcs.c

ASM_OFILES := ./assembler/main_assembler.o ./assembler/print_errors_usage.o  ./assembler/encoding_funcs.o
