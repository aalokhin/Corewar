...
ASM_SFILES := ./assembler/labels_nastia.c ./assembler/main_assembler.c ./assembler/print_errors_usage.c ./assembler/encoding_funcs.c ./assembler/output_to_file.c ./assembler/parse_file_funcs.c  ./assembler/parse_commands.c ./assembler/commands_help_funcs.c ./assembler/printer.c

ASM_OFILES := ./assembler/labels_nastia.o ./assembler/main_assembler.o ./assembler/print_errors_usage.o  ./assembler/encoding_funcs.o ./assembler/output_to_file.o ./assembler/parse_file_funcs.o  ./assembler/parse_commands.o ./assembler/commands_help_funcs.o ./assembler/printer.o
